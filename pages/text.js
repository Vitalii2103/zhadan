            ...
            <div className="main flex-container">
                ...
                <div className="right-side">
                    ...
                    <div className="btn-menu">
                        ...
                        <a href="/zadan" className="btn big grey waves-effect waves-light darken-4">Жадан і Собаки</a>
                        <a href="/text" className="btn big grey waves-effect waves-light ">Тексти</a>
                    </div>
                    <div id="posts">
